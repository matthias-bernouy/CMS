...
l'agencement interne **obligatoire** de `official-data-providers/<name>/`.

Un official data-provider est un **service API-only, multi-tenant, à
...
**package** `official-data-providers/_sdk/`. Sa surface est spécifiée dans
[`_sdk.md`](_sdk.md).
