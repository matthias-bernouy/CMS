import { z } from "zod";
import { DATA_PROVIDER_CONTRACT_VERSION, CRYPTO_DEFAULTS } from "@bernouy/data-provider-contract";
 ...
 *  of truth — also consumed by `dataProviderInfo.ts` and (as a TS type)
...
export const ProviderConfigSchema = z.object({
    ...
    supportedContractVersion:   z.string().min(1).default(DATA_PROVIDER_CONTRACT_VERSION),
