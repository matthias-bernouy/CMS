...
// Same wiring pattern as docker/example-dp: SDK provider mount + issuer-kit
// metadoc/JWKS. Stateless DP, MemoryLogStore in dev so the unprivileged
...
import { makeAddresses } from "@bernouy/data-provider-addresses";
...
const DP_PUBLIC_URL    = env("DP_PUBLIC_URL");
...
runner.start(PORT);
console.log(`🚀 addresses-dp listening on :${PORT}`);
