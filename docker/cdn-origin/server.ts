// Origin bootstrap — composes @bernouy/cdn's StorageProvider with
// @bernouy/cdn-origin's OriginProvider on the same Bun runner, behind a
...
// Mirror @bernouy/cdn's `createAdminGuard` so a single Keycloak session
...
new OriginProvider({
    ...
    config: {
        lsyncd: {
            ...
            // lego/webroot, lego/accounts). Edges receive buckets/,
            // lego/certificates/ and nginx-generated/.
