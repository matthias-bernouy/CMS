...
```bash
cd /path/to/CmsCore
docker build -t bernouy/cms:basic -f infra/images/cms/Dockerfile .
...
scp infra/images/cms/infra/compose.yml          user@SERVER:/opt/cms-infra/compose.yml
scp infra/images/cms/compose.yml                user@SERVER:/opt/cms-sites/_template/compose.yml
```
