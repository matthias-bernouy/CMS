...
const blocs: Array<[string, string]> = [
    ...
    ["form-section", "./src/ui/Form/FormSection.ts"],
    ["icon-button", "./src/ui/Form/IconButton/IconButton.ts"],
    ["input-file", "./src/ui/Form/InputFile/InputFile.ts"],
    ["p9r-input", "./src/ui/Form/P9rInput.ts"],
    ["p9r-range", "./src/ui/Form/P9rRange.ts"],
    ["p9r-select", "./src/ui/Form/P9rSelect.ts"],
    ...
    ["toast", "./src/ui/Toast/Toast.ts"],
    ["toast-stack", "./src/ui/Toast/ToastStack.ts"],
...
// declarations, so `import { Foo } from "@bernouy/webcomponents/blocs/foo"`
