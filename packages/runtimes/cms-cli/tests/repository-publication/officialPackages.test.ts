...
const EXPECTED_COORDINATES = [
    ...
    "sales-configurator@3.0.0",
    "stripe-connect@1.0.0",
    "stripe-connect@2.1.2",
    "stripe-connect@3.0.0",
    "ulvia@1.0.0",
    "ulvia@2.0.0",
    "user-account@1.0.0",
    "user-account@2.0.0",
