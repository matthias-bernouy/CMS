...
export const PRODUCTION_SYSTEM_FUNCTION_JOBS: readonly ScheduledSystemFunctionJob[] = [
...
export function startProductionSystemFunctionWorkers(options: {
    functions: FunctionRepository;
    sources: SourceRepository;
    deps: ExecutorDeps;
}): ScheduledSystemFunctionRunner {
    return startScheduledSystemFunctions({ ...options, jobs: PRODUCTION_SYSTEM_FUNCTION_JOBS });
}
