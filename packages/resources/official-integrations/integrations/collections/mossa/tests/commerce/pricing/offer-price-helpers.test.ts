...
import {
    ...
    majorToMinor,
    minorToMajor,
} from "@bernouy/cms-official-integrations/integrations/mossa/blocs/domains/commerce/offers/pricing/commerce-offer-price-form/money.ts";
import {
    parseDate,
    profileFieldReady,
    PublicError,
    stripeEnrollmentComplete,
} from "@bernouy/cms-official-integrations/integrations/mossa/blocs/domains/commerce/offers/pricing/commerce-offer-price-form/profile.ts";
...
describe("commerce offer price helpers", () => {
    ...
    test("validates calendar dates and ready profile fields", () => {
        ...
        expect(profileFieldReady("countryCode", "be")).toBe(true);
        expect(profileFieldReady("countryCode", "f")).toBe(false);
    });
