...
import accountOffersTemplate from "@bernouy/cms-official-integrations/integrations/mossa/blocs/domains/commerce/accounts/commerce-account-offers/template.html" with {
    type: "text",
};
