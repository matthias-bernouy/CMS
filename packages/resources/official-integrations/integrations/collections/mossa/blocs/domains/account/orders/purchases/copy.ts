export const purchaseCopy: Record<string, string> = {
    ...
    "label-preparing": "Being prepared",
    "label-handoff-declared": "Waiting for carrier scan",
    "label-in-transit": "In transit",
    "label-pickup-ready": "Available for pickup",
    "label-delivered": "Delivered",
    "label-delivery-incident": "Delivery incident",
    "label-parcel-lost": "Parcel lost",
    "label-pickup-expired": "Pickup period expired",
    "label-returning-to-sender": "Returning to sender",
    "label-returned-to-sender": "Returned to sender",
