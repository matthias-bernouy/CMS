...
export function connectOfferList(host) {
    ...
    host.addEventListener("mossa-pagination:change", host.onPageChange);
    host.addEventListener("mossa-commerce-offer-filter:state", host.onSchemaState);
...
export function disconnectOfferList(host) {
    host.removeEventListener("mossa-pagination:change", host.onPageChange);
    host.removeEventListener("mossa-commerce-offer-filter:state", host.onSchemaState);
