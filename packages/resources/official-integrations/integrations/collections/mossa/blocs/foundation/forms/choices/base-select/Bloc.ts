...
const ATTR_MIRROR = ["name", "required", "disabled", "multiple", "autofocus"];
...
export class Bloc extends Component {
    ...
    private _rebuild = () => {
        ...
        const options = Array.from(this.querySelectorAll(":scope > base-select-option")) as HTMLElement[];
