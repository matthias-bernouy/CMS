...
class MossaCheckbox extends HTMLElement {
    ...
    constructor() {
        ...
        this.root.innerHTML = `
            <style>
                ...
                :host {
                    --_mossa-checkbox-background: var(--ulvia-surface-background);
                    --_mossa-checkbox-border: var(--ulvia-surface-border);
                    --_mossa-checkbox-checked-background: var(--_mossa-tone-base);
                    --_mossa-checkbox-checked-border: var(--_mossa-tone-border);
                    --_mossa-checkbox-check-color: var(--_mossa-tone-foreground);
                    display: inline-block;
                    color: var(--_mossa-input-color, var(--ulvia-surface-text));
                    font: inherit;
                }

                :host([appearance="soft"]) {
                    --_mossa-checkbox-checked-background: var(--_mossa-tone-muted);
                    --_mossa-checkbox-checked-border: var(--_mossa-tone-muted);
                    --_mossa-checkbox-check-color: var(--_mossa-tone-contrasted);
                }

                :host([appearance="outlined"]) {
                    --_mossa-checkbox-checked-background: transparent;
                    --_mossa-checkbox-checked-border: var(--_mossa-tone-border);
                    --_mossa-checkbox-check-color: var(--_mossa-tone-contrasted);
                }
                ...
                input {
                    ...
                    margin: .15rem 0 0;
                    border: 1px solid var(--_mossa-checkbox-border);
                    border-radius: var(--ulvia-radius-sm);
                    background: var(--_mossa-checkbox-background);
                    color: var(--_mossa-checkbox-check-color);
                    cursor: pointer;
                ...
                input:checked {
                    border-color: var(--_mossa-accent-color, var(--_mossa-checkbox-checked-border));
                    background: var(--_mossa-accent-color, var(--_mossa-checkbox-checked-background));
                }
                ...
                :host([presentation="switch"]) input::after {
                    ...
                    border: 0;
                    border-radius: 50%;
                    background: var(--_mossa-checkbox-check-color);
                    opacity: 1;
                    transform: none;
                ...
                .error {
                    display: block;
                    color: var(--_mossa-error-color, var(--ulvia-danger-base));
                }
...
customElements.define("BE5_TAG_TO_BE_REPLACED", MossaCheckbox);
