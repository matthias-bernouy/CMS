...
create table if not exists stripe_connect.payments (
    ...
    client_reference_id text not null constraint payments_client_reference_id_key unique,
    ...
    stripe_payment_intent_id text constraint payments_stripe_payment_intent_id_key unique,
    stripe_charge_id text constraint payments_stripe_charge_id_key unique,
    stripe_charge_balance_transaction_id text constraint payments_stripe_charge_balance_transaction_id_key unique,
    last_stripe_event_id text,
    transfer_group text not null constraint payments_transfer_group_key unique,
