...
create table if not exists stripe_connect.refunds (
    ...
    operation_id bigint not null constraint refunds_operation_id_key unique references stripe_connect.financial_operations(id) on delete restrict,
    refund_request_id text not null constraint refunds_refund_request_id_key unique,
    commerce_refund_request_id bigint constraint refunds_commerce_refund_request_id_key unique,
    stripe_refund_id text constraint refunds_stripe_refund_id_key unique,
    stripe_balance_transaction_id text constraint refunds_stripe_balance_transaction_id_key unique,
