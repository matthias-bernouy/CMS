...
const commerceDefinitionUrl = new URL("../../../../../domains/commerce/definition.json", import.meta.url);
const compositionDefinitionUrl = new URL("../../../definition.json", import.meta.url);
