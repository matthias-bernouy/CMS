...
export const variants = [
    {
        id: 100, product_id: 42, sku: null, title: "L1 / Red", status: "active", position: 0,
        combination_key: "grip:l1|color:red", generated_from_axes: true,
        metadata: { publicSpec: "variant", variantSecret: "kept" }, version: 2,
        created_at: "2026-07-02T10:00:00Z", updated_at: "2026-07-03T10:00:00Z",
    },
    {
        id: 101, product_id: 42, sku: "INCOMPLETE", title: "Incomplete", status: "archived", position: 1,
        combination_key: null, generated_from_axes: true, metadata: {}, version: 1,
        created_at: "2026-07-02T11:00:00Z", updated_at: "2026-07-02T11:00:00Z",
    },
];
...
export const media = [
    {
        id: 301, media_id: 501, sort_order: 1, is_main: false,
        media: {
            id: 501, storage_bucket: "commerce-media", storage_path: "products/42/side.webp",
            mime_type: "image/webp", file_size: 1200, original_filename: "side.webp", alt: null,
            created_at: "2026-07-01T11:00:00Z", updated_at: "2026-07-01T11:00:00Z",
        },
    },
    {
        id: 302, media_id: 502, sort_order: 2, is_main: true,
        media: {
            id: 502, storage_bucket: "commerce-media", storage_path: "products/42/front.webp",
            mime_type: "image/webp", file_size: 1400, original_filename: "front.webp", alt: "Front",
...
export const categories = [
    {
        product_id: 42, category_id: 9, is_primary: true, position: 2,
        category: {
            id: 9, parent_id: 3, slug: "rackets", full_slug: "sports/rackets",
            label: "Rackets", status: "active", position: 2,
        },
    },
    {
        product_id: 42, category_id: 12, is_primary: false, position: 4,
        category: {
            id: 12, parent_id: null, slug: "featured", full_slug: "featured",
            label: "Featured", status: "draft", position: 4,
        },
    },
];
...
export const newProduct = {
    ...
    status: "draft", visibility: "public", metadata: {}, media: [], mainImageMediaId: null,
    variantAxes: [], variants: [], variantMatrix: [], version: 1,
};
...
function productProjection(metadata: Record<string, unknown>) {
    ...
    const matrix = [{
        ...
        choices: [
            ...
            { axisKey: "color", axisLabel: "Color", valueKey: "red", valueLabel: "Red", fieldKey: "finishColor", value: "red" },
        ],
        effectiveMetadata: {
            ...metadata,
            publicSpec: "variant",
...
function sourceProjection(product: any, admin: boolean): Record<string, unknown> {
    ...
    return admin
        ? { ...projection, brandId, brand: productBrand, primaryCategoryId, primaryCategory }
        : projection;
}
