-- Protected payment, fulfillment, and claim deadline contract.
...
\if :{?run_protected_deadline_contract}
\else
    \echo 'Set run_protected_deadline_contract=true to run this contract.'
    \quit 3
\endif

\if :{?allow_protected_deadline_schema_reset}
\else
    \echo 'Set allow_protected_deadline_schema_reset=true on a disposable database.'
    \quit 3
\endif
