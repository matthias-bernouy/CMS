...
export const claimEvents = [
    {
        id: 71, claim_id: 7, event_type: "opened", actor_kind: "buyer",
        actor_id: "buyer-17", message: null,
        data: { internal_key: "kept_opaque" }, created_at: "2026-07-17T08:00:00.000Z",
    },
    {
        id: 72, claim_id: 7, event_type: "return_required", actor_kind: "admin",
        actor_id: "admin-3", message: "Return authorized",
        data: { return_flow: true }, created_at: "2026-07-18T08:00:00.000Z",
    },
];

export const claimEvidenceRows = [
    {
        id: 81, claim_id: 7, submitted_by_kind: "buyer", submitted_by: "buyer-17",
        storage_bucket: "commerce-claim-evidence", storage_path: "claims/private/buyer.pdf",
        mime_type: "application/pdf", file_size: 1_024, original_filename: "buyer-proof.pdf",
        sha256: "a".repeat(64), description: null,
        metadata: { upload_kind: "buyer" }, created_at: "2026-07-17T09:00:00.000Z",
    },
    {
        id: 82, claim_id: 7, submitted_by_kind: "seller", submitted_by: "seller-4",
        storage_bucket: "commerce-claim-evidence", storage_path: "claims/private/seller.png",
        mime_type: "image/png", file_size: 2_048, original_filename: "seller-proof.png",
        sha256: "b".repeat(64), description: "Packing photograph",
        metadata: { upload_kind: "seller" }, created_at: "2026-07-17T10:00:00.000Z",
    },
];

export const claimReturnEvents = [
    {
        id: 91, provider_event_id: "return:event:1", provider_reference: "return-42",
        normalized_status: "carrier_accepted", occurred_at: "2026-07-20T08:00:00.000Z",
        created_at: "2026-07-20T08:01:00.000Z",
    },
    {
        id: 92, provider_event_id: "return:event:2", provider_reference: "return-42",
        normalized_status: "in_transit", occurred_at: "2026-07-21T08:00:00.000Z",
...
export function useClaimDetailResponder(options: Options = {}): void {
    ...
    setRestResponder(request => {
        ...
        if (path.endsWith("/rest/v1/marketplace_claim_events")) return jsonResponse(events);
        if (path.endsWith("/rest/v1/marketplace_claim_evidence")) return jsonResponse(evidence);
