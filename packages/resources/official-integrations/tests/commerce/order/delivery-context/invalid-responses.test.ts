...
describe("commerce delivery context response validation", () => {
    const malformedSetup = [
        ...
        ["an order field is missing", ok({
            ...setupContext,
            order: { ...setupContext.order, public_id: undefined },
        })],
        ["the order version is unsafe", ok({
            ...setupContext,
            order: {
                ...setupContext.order,
        ...
        ["the authorization has a wrong type", ok({
            ...setupContext,
            authorization: [],
        })],
        ["an authorization field is missing", ok({
            ...setupContext,
            authorization: {
        ...
        ["the shipping address is not an object", ok({
            ...setupContext,
            authorization: {
                ...setupContext.authorization,
        ...
        ["the order belongs to another actor", ok({
            ...setupContext,
            order: {
                ...setupContext.order,
        ...
        ["an awaiting order has no authorization", ok({
            ...setupContext,
            authorization: null,
        })],
        ["a non-awaiting order has an authorization", ok({
            order: {
                ...setupContext.order,
                status: "cancelled",
            },
        ...
        ["the authorization buyer changed", ok({
            ...setupContext,
            authorization: {
                ...setupContext.authorization,
                buyer_cms_user_id: "another-buyer",
        ...
        ["the authorization status changed", ok({
            ...setupContext,
            authorization: {
                ...setupContext.authorization,
                status: "cancelled",
        ...
        ["the authorization version changed", ok({
            ...setupContext,
            authorization: {
                ...setupContext.authorization,
                order_version: 8,
    ...
    const malformedSelection = [
        ...
        ["the context is missing", { state: "ok" }],
        ["a field is missing", ok({
            ...selectionContext,
            delivery_quote_id: undefined,
        })],
        ["the public id has a wrong type", ok({
            ...selectionContext,
            public_id: 42,
        })],
        ["the buyer id has a wrong type", ok({
            ...selectionContext,
        ...
        ["the quote id has a wrong type", ok({
            ...selectionContext,
