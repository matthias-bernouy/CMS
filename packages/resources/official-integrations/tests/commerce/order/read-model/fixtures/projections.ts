...
export const operation = {
    ...
    seller_proceeds_amount: 9_000,
    platform_retained_amount: 2_070,
    financial_terms_hash: "terms-hash-42",
    payment_status: "succeeded",
    fulfillment_status: "in_transit",
    settlement_status: "held",
    claim_status: "open",
    total_refund_requested_amount: 620,
    release_eligible_at: "2026-07-20T12:00:00.000Z",
    recipient_handoff_at: null,
    recipient_handoff_first_observed_at: null,
    claim_window_started_at: null,
    claim_by_at: "2026-07-22T12:00:00.000Z",
...
export const financialTerms = {
    ...
    seller_commission_amount: 1_000,
    buyer_total_amount: 11_070,
    seller_proceeds_amount: 9_000,
    platform_retained_amount: 2_070,
    currency: "eur",
...
export const sellerFinancialTerms = {
    ...
    seller_proceeds_amount: 9_000,
    seller_transfer_release_amount: 8_500,
...
export const fulfillment = {
    order_id: 42,
    status: "in_transit",
    seller_handoff_deadline: "2026-07-13T12:00:00.000Z",
    scan_grace_deadline: "2026-07-14T12:00:00.000Z",
    carrier_accepted_at: "2026-07-13T13:00:00.000Z",
    arrived_at_pickup_point_at: null,
    available_for_pickup_at: null,
    recipient_handoff_at: null,
    recipient_handoff_first_observed_at: null,
    claim_window_started_at: null,
    claim_by_at: "2026-07-22T12:00:00.000Z",
...
export const settlement = {
    order_id: 42,
    status: "held",
    authorized_seller_amount: 9_000,
    total_transferred_amount: 0,
    total_reversed_amount: 0,
    total_refunded_amount: 620,
    seller_reserve_liability_remaining_amount: 500,
    version: 2,
};

export const claim = {
    id: 88,
    public_id: "20000000-0000-4000-8000-000000000088",
    reason: "damaged",
    status: "open",
    seller_response_by_at: "2026-07-15T12:00:00.000Z",
