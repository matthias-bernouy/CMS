...
export const expectedAdminEvents = expectedBuyerEvents.map((event, index) => ({
    ...event,
    actorKind: index ? "system" : "buyer",
    actorId: index ? "stripe" : "buyer-user-42",
...
export const expectedOperation = {
    ...
    sellerId: 17,
    currency: "eur",
    buyerTotalAmount: 11_070,
    sellerProceedsAmount: 9_000,
    platformRetainedAmount: 2_070,
...
export const expectedClaim = {
    id: 88,
    publicId: "20000000-0000-4000-8000-000000000088",
    reason: "damaged",
    status: "open",
    sellerResponseByAt: "2026-07-15T12:00:00.000Z",
    returnShipByAt: null,
    resolvedAt: null,
    version: 1,
