...
export const orderRows = [
    {
        id: 42,
        public_id: firstOrderPublicId,
        order_number: "CO-42",
        line_summary: { first_title: "Tennis racket", line_count: 2, total_quantity: 3 },
        ...
        idempotency_key: "checkout-key-42",
        archived_at: null,
        version: 3,
    ...
    {
        id: 41,
        public_id: secondOrderPublicId,
        order_number: "CO-41",
        line_summary: { first_title: "Padel racket", line_count: 1, total_quantity: 1 },
        ...
        shipping_amount: 0,
        delivery_quoted_at: "2026-07-11T11:02:00.000Z",
        total_amount: 8_300,
        shipping_address: { recipient: "Buyer", addressLine1: "41 Market St" },
        billing_address: {},
        metadata: { publicNote: "Front desk", internalRisk: "low" },
        idempotency_key: "checkout-key-41",
...
export const saleRows = orderRows.map(
    ({
        seller_id: _seller,
        buyer_cms_user_id: _buyer,
...
export const operationListRows = [
    {
        ...
        claim_status: "open",
        total_refund_requested_amount: 620,
...
export const buyerEventRows = [
    ...
    },
    {
        ...
        next_status: "active",
        created_at: "2026-07-12T12:03:00.000Z",
    },
];

export const adminEventRows = buyerEventRows.map((event, index) => ({
    ...event,
    actor_kind: index ? "system" : "buyer",
    actor_id: index ? "stripe" : buyerId,
    message: index ? null : "Order created",
    data: index ? { provider: "stripe" } : {},
}));
