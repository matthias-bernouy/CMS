...
import { createTerminalPageFixture, successfulJson, type CreateProviderReconciliationHarness } from "../harness";

const createdAt = "2026-07-21T09:00:00.000Z";
const updatedAt = "2026-07-21T09:05:00.000Z";

export function registerTerminalPageContract(createHarness: CreateProviderReconciliationHarness): void {
