    ...
    return {
        ...
        input: {
            body: object(
                ...
                ["quoteId", "externalOrderId", "selectedForCmsUserId", "purpose"],
            ),
        },
        output: [{ status: "200", body: quoteShape() }, errorOutput("404"), errorOutput("409")],
    };
}
...
function createShipment(): SourceEndpoint {
    ...
    return {
        ...
        input: { body },
        output: [shipmentOutput("201", false), shipmentOutput("200", true), errorOutput("400"), errorOutput("409")],
    };
}
