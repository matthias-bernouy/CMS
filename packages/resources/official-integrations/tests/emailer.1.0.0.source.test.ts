...
import { registerDeliveryTests } from "./emailer/scenarios/delivery";
import { registerInstallationTest } from "./emailer/scenarios/installation";
import { registerSettingsTests } from "./emailer/scenarios/settings";
