...
export function registerContainerTest(): void {
    test("container constrains content with theme widths and responsive gutters", async () => {
        ...
        expect(styles).toContain("var(--integration-basic-blocs-content-width, var(--content-width, 68rem))");
        expect(styles).toContain("var(--integration-basic-blocs-wide-width, var(--wide-width, 82rem))");
        expect(styles).toContain("var(--integration-basic-blocs-space-md, var(--space-md, 1rem))");
