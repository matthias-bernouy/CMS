...
export class InputFile extends Component {
        ...
        switch (name) {
            case "accept":
                if (newVal === null) {
                    ...
                    this._input.setAttribute("accept", newVal);
                }
                break;
            case "multiple":
    ...
    private _onChange = () => updateFileValue(this, this._input, this._preview, this._liveRegion, this._internals);
    private _onDragOver = (e: Event) => handleDragOver(this, e);
    private _onDragLeave = (e: Event) => handleDragLeave(this, e);
    private _onDrop = (e: Event) => handleDrop(this, this._input, this._preview, this._liveRegion, this._internals, e);
    ...
    set accept(v: string) {
        v ? this.setAttribute("accept", v) : this.removeAttribute("accept");
    }
