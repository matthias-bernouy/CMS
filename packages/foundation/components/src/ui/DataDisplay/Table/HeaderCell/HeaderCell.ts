...
import { handleSortClick, handleFilterToggle, handleFilterEnter, closeFilterPopover } from "./listener";
...
export class TableHeaderCell extends Component {
    ...
    private _onFilterToggle = (e: Event) =>
        handleFilterToggle(e, this._filterBtn, this._filterPopover, this._filterInput);
