...
const blocs: Array<[string, string]> = [
    ...
    ["combobox", "./src/ui/Form/Combobox/Combobox.ts"],
    ...
    ["token-input", "./src/ui/Form/TokenInput/TokenInput.ts"],
    ...
    ["action-menu", "./src/ui/Menu/ActionMenu/ActionMenu.ts"],
    ["action-menu-item", "./src/ui/Menu/ActionMenu/ActionMenuItem/ActionMenuItem.ts"],
    ["action-menu-section", "./src/ui/Menu/ActionMenu/ActionMenuSection/ActionMenuSection.ts"],
