 ...
 * this list in sync with `packages/cdn-buckets/src/core/admin/mountAdminSurface.ts`
...
const ICON_CHART   = `<svg slot="icon" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/></svg>`;
...
<w13c-left-menu-layout style="--_content-padding: 0;">
    <w13c-lateral-menu slot="sidebar" style="width: 100%; height: 100%;">
        ...
        <w13c-lateral-menu-item href="/admin/origin/logs">${ICON_CHART}Logs</w13c-lateral-menu-item>
