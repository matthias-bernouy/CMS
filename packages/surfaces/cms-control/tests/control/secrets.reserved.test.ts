...
import getSecretKeys from "cms-control/api/secrets/keys.get";
import deleteSecret from "cms-control/api/secrets/secrets.delete";
import getSecrets from "cms-control/api/secrets/secrets.get";
import postSecret from "cms-control/api/secrets/secrets.post";
