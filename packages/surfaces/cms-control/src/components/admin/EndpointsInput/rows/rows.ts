...
import { makeInput, makeMethodSelect, makeDeleteButton } from "../fields/controls";
import { makeInPanel } from "../panels/inPanel";
import { makeOutPanel } from "../panels/outPanel";
import { makeHeadersPanel } from "../panels/headersPanel";
...
export function makeEndpointRow(idx: number, seed: EndpointSeed = {}, api?: string): HTMLElement {
    ...
    const method =
        seed.method && (HTTP_METHODS as readonly string[]).includes(seed.method) ? seed.method : HTTP_METHODS[0];
