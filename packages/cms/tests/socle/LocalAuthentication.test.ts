...
import { LocalAuthentication } from "src/socle/auth/LocalAuthentication";
import { SubjectResolver } from "src/socle/auth/SubjectResolver";
import { InMemoryUsersRepository } from "src/socle/default-implementation/UsersRepository/memory";
import { InMemoryLocalCredentialStore } from "src/socle/default-implementation/LocalCredentialStore/memory";
import { InMemoryPatRepository } from "src/socle/default-implementation/PatRepository/memory";
import { InMemoryRateLimiter } from "src/socle/default-implementation/RateLimiter/memory";
