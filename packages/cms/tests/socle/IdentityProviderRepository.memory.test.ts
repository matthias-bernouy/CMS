...
import { InMemoryIdentityProviderRepository } from "src/socle/default-implementation/IdentityProviderRepository/memory";
import type { NewIdentityProvider } from "src/socle/interfaces/IdentityProvider";
