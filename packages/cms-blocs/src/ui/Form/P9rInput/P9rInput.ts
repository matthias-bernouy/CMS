...
export class P9rInput extends Component {
    ...
    constructor() {
        ...
        if (this._labelEl && this._input) { this._labelEl.id = labelId; this._input.setAttribute('aria-labelledby', labelId); }
    }
    ...
    override connectedCallback() {
        ...
        else updateCounter(this, this._input, this._counterEl, this._countEl);
    }
    ...
    attributeChangedCallback(name: string, _oldVal: string | null, newVal: string | null) {
        ...
        else if (name === 'label') syncLabel(this, this._labelEl);
        ...
        } else syncAll(this, this._input, this._labelEl, this._hintEl, this._metaEl, this._counterEl, this._maxEl);
    }
