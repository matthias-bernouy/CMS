...
export class Textarea extends Component {
    ...
    static get observedAttributes() {
        return ['value', 'label', 'placeholder', 'rows', 'maxlength', 'max-count',
    ...
    override connectedCallback() {
        ...
        else updateCounter(this, this._textarea, this._counter, this._count);
    }
    ...
    formResetCallback() { this.value = this._defaultValue; }

    attributeChangedCallback(name: string, _oldVal: string | null, newVal: string | null) {
        if (!this._textarea) return;
        if (name === 'value' && newVal !== null) this.value = newVal;
        else if (name === 'max-count') { syncMaxCount(this, this._counter, this._max, this._hint, this._meta); updateCounter(this, this._textarea, this._counter, this._count); }
        else if (name === 'autosize') autosize(this, this._textarea);
        else syncAll(this, this._textarea, this._label, this._hint, this._meta, this._counter, this._max);
    }
