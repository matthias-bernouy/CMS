...
export class FormSection extends Component {
    ...
    static get observedAttributes() { return ['collapsed', 'data-title']; }
    ...
    attributeChangedCallback(name: string) {
        if (name === 'collapsed') syncAria(this, this._toggle, this._content);
        if (name === 'data-title') syncTitle(this, this._title);
    }
