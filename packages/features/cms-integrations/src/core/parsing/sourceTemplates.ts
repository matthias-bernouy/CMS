...
function parseArtifactTemplate(value: unknown, name: string): DeclarativeArtifactTemplate {
    ...
    throw new IntegrationInputError(`${name}.type`, "must be source, function, dashboard, or bloc");
}

function parseFunctionTemplate(value: Record<string, unknown>, name: string): FunctionDto {
