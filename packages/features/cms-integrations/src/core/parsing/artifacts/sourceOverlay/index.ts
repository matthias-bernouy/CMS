...
export function parseSourceOverlayTemplate(value: Record<string, unknown>, name: string): SourceOverlay {
    return {
        ...
        ...(value.fieldSource !== undefined ? { fieldSource: parseOverlayFieldSource(value.fieldSource, `${name}.fieldSource`) } : {}),
        ...(value.sections !== undefined ? { sections: parseOverlaySections(value.sections, `${name}.sections`) } : {}),
        ...(value.dashboardFields !== undefined ? { dashboardFields: parseOverlayDashboardFields(value.dashboardFields, `${name}.dashboardFields`) } : {}),
...
function parseOverlayFieldSourceMap(value: unknown, name: string): SourceOverlayFieldSourceMap {
    ...
    return Object.fromEntries(Object.entries(value)
        ...
        .map(([key, path]) => [key, text(path)!])) as SourceOverlayFieldSourceMap;
}
...
function parseOverlayTargets(value: unknown, name: string): SourceOverlayEndpointTarget[] {
    ...
    return value.map((entry, index) => {
        ...
        return {
            ...
            ...(entry.editable !== undefined ? { editable: parseOverlayEditable(entry.editable, `${name}.${index}.editable`) } : {}),
        };
    });
}
