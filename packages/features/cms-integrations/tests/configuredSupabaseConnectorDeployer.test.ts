...
async function createSchemaFixture(): Promise<string> {
...
function schemaDeployment(): IntegrationConnectorDeployment {
    return {
        ...emptyDeployment(),
...
function emptyDeployment(): IntegrationConnectorDeployment {
    return {
...
function emptyContext(): IntegrationConnectorDeployContext {
