                ...
                endpoints: [
                    {
                        ...
                        method: "POST",
                        access: { mode: "admin" },
                        targetUrl: "https://integration.test/connection",
                    ...
                    widgets: [
                        {
                            ...
                            save: { endpoint: "write", valuesPath: "values" },
                            main: [
                                {
                                    id: "connection",
                                    title: "Connection",
...
export async function fixture(
    ...
    await installations.create({
        ...
        artifacts: [
            { id: "manage", type: "function", action: "created" },
            { id: "urn:managed", type: "source", action: "created" },
        ],
    });
