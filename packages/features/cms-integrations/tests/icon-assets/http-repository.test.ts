...
function definition(svg?: string): Record<string, unknown> {
    return {
        kind: "remote-icons",
        label: "Remote icons",
        version: "2.1.0",
...
function sourceArtifact(id: string, path: string, svg?: string): Record<string, unknown> {
    return {
        type: "source",
        source: {
            id,
