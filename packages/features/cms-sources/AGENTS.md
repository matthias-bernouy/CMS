...
Feature package for data sources, endpoint contracts, request execution,
OpenAPI import, and source proxy helpers.

## Boundaries

- Root export exposes source/endpoint types, validation, repositories,
  OpenAPI parsing/import helpers, request execution, system sources, and
  source HTTP helpers.
...
- OpenAPI import must stay deterministic so source diffs are reviewable.
