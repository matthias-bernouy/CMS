import type { EndpointParam, SourceEndpoint } from "cms-sources/interfaces/Source";
import { COMPUTED_PARAM_REFS, PARAM_INS } from "cms-sources/interfaces/Source";
import {
    isForbiddenHeaderName,
    isValidHeaderName,
    isValidHeaderValue,
    MAX_ENDPOINT_HEADERS,
} from "cms-sources/core/upstream/headerPolicy";

export function validateParams(endpoint: SourceEndpoint, errors: string[]): void {
