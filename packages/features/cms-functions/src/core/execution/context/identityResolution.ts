...
import type { CmsFunction, FunctionCall, FunctionValue } from "cms-functions/interfaces/FunctionDefinition";
...
import { referenceShape } from "cms-functions/core/execution/context/referenceShapes";
