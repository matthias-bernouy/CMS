...
import { InMemoryIdentityProviderRepository } from "auth-core/default-implementation/IdentityProviderRepository/memory";
import type { NewIdentityProvider } from "auth-core/interfaces/IdentityProvider";
