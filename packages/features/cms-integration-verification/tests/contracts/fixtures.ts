...
export function verificationReport(finding?: CompatibilityFinding): VerificationReport {
    ...
    return {
        ...
        admissionInputDigest: DIGEST_B,
        verificationJobResultDigest: DIGEST_C,
        dependencies: [],
        baselines: [
            {
                kind: "example",
...
export function migrationReport(): MigrationReport {
    ...
    return {
        ...
        policy: { name: "default-admission", version: "1.2.0" },
        policySnapshotDigest: DIGEST_C,
        migrationInputDigest: DIGEST_B,
        migrationJobResultDigest: DIGEST_C,
        statefulChangeSelectionDigest: DIGEST_B,
...
export function admissionDecision(): ReleaseAdmissionDecision {
    return {
        ...
        version: "1.2.0",
        packageDigest: DIGEST_A,
        compatibilityReport: { revisionId: "compatibility-1", reportDigest: DIGEST_B },
        verificationReport: { revisionId: "verification-1", reportDigest: DIGEST_C },
        migrationReports: [
            {
                revisionId: "migration-1",
