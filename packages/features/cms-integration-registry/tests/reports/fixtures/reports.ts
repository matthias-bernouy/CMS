...
export async function migrationReport(
    ...
    return {
        ...
        policyEvaluation: {
            ...
            satisfied: true,
            checks: [
                { check: "report-outcome", applicable: true, satisfied: true, observed: "passed" },
                { check: "environment", applicable: true, satisfied: true, observed: "b".repeat(64) },
            ],
            reasons: [],
        },
        operationalEvidence: {
            ...
            drain: {},
            rollback: { capability: "available", verified: true, evidenceDigest: EVIDENCE_DIGEST },
            pointOfNoReturn: { phase: "cleanup", observation: "crossed", evidenceDigest: EVIDENCE_DIGEST },
            cleanup: { observed: true, evidenceDigest: EVIDENCE_DIGEST },
        },
        cutoverEvidence: {
            cmsMediated: passed,
